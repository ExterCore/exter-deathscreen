## You can either follow these steps or you can use our fully complete qb-ambulancejob which will automatically install it for you without needing this setup readme.md, you choose.
